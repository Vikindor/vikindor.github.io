(function (g) {
    g.__tsParticlesInternals = g.__tsParticlesInternals || {};
    g.__tsParticlesInternals.bundles = g.__tsParticlesInternals.bundles || {};
    g.__tsParticlesInternals.effects = g.__tsParticlesInternals.effects || {};
    g.__tsParticlesInternals.engine = g.__tsParticlesInternals.engine || {};
    g.__tsParticlesInternals.interactions = g.__tsParticlesInternals.interactions || {};
    g.__tsParticlesInternals.palettes = g.__tsParticlesInternals.palettes || {};
    g.__tsParticlesInternals.paths = g.__tsParticlesInternals.paths || {};
    g.__tsParticlesInternals.plugins = g.__tsParticlesInternals.plugins || {};
    g.__tsParticlesInternals.plugins = g.__tsParticlesInternals.plugins || {};
    g.__tsParticlesInternals.plugins.emittersShapes = g.__tsParticlesInternals.plugins.emittersShapes || {};
    g.__tsParticlesInternals.presets = g.__tsParticlesInternals.presets || {};
    g.__tsParticlesInternals.shapes = g.__tsParticlesInternals.shapes || {};
    g.__tsParticlesInternals.updaters = g.__tsParticlesInternals.updaters || {};
    g.__tsParticlesInternals.utils = g.__tsParticlesInternals.utils || {};
    g.__tsParticlesInternals.canvas = g.__tsParticlesInternals.canvas || {};
    g.__tsParticlesInternals.canvas = g.__tsParticlesInternals.canvas || {};
    g.__tsParticlesInternals.canvas.utils = g.__tsParticlesInternals.canvas.utils || {};
    g.__tsParticlesInternals.path = g.__tsParticlesInternals.path || {};
    g.__tsParticlesInternals.path = g.__tsParticlesInternals.path || {};
    g.__tsParticlesInternals.path.utils = g.__tsParticlesInternals.path.utils || {};
    var __tsProxyFactory = typeof Proxy !== "undefined" ? function (obj) {
    ...
    g.tsparticlesInternalExports = g.tsparticlesInternalExports || {};
})(typeof globalThis !== "undefined" ? globalThis : typeof window !== "undefined" ? window : this);
/* tsParticles v4.0.2 */
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports) :
        typeof define === 'function' && define.amd ? define(['exports'], factory) :
            (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.__tsParticlesInternals = global.__tsParticlesInternals || {}, global.__tsParticlesInternals.bundles = global.__tsParticlesInternals.bundles || {}, global.__tsParticlesInternals.bundles.slim = global.__tsParticlesInternals.bundles.slim || {})));
})(this, (function (exports) {
    'use strict';

    const generatedAttribute = "generated", defaultCompositeValue = "source-over", resizeEvent = "resize",
        visibilityChangeEvent = "visibilitychange", percentDenominator = 100, half$1 = 0.5,
        millisecondsToSeconds = 1000, originPoint = {
            x: 0,
            y: 0,
            z: 0,
        }, defaultTransform = {
            ...
            c: 0,
            d: 1,
        }, randomColorValue = "random", midColorValue = "mid", double = 2, doublePI = Math.PI * double, defaultFps = 60,
        defaultAlpha$1 = 1, generatedTrue = "true", generatedFalse = "false", canvasTag = "canvas",
        defaultRetryCount = 0, squareExp$1 = 2, spatialHashGridCellSize = 100, defaultRemoveQuantity = 1,
        defaultRatio$1 = 1, defaultReduceFactor = 1, inverseFactorNumerator = 1, rgbMax = 255, hMax = 360, sMax = 100,
        lMax = 100, hMin = 0, sMin = 0, hPhase = 60, empty = 0, quarter = 0.25, threeQuarter = half$1 + quarter,
        minVelocity$6 = 0, defaultTransformValue = 1, minimumSize = 0, zIndexFactorOffset = 1, defaultOpacity$3 = 1,
        removeDeleteCount = 1, removeMinIndex = 0, defaultFpsLimit = 120, minFpsLimit = 0, canvasFirstIndex = 0,
        loadRandomFactor = 10000, loadMinIndex = 0, one = 1, none = 0, decayOffset = 1, tryCountIncrement = 1, minZ = 0,
        minLimit = 0, countOffset = 1, minCount = 0, minIndex = 0, lengthOffset = 1, defaultDensityFactor = 1,
        deleteCount = 1, defaultAngle = 0, identity$3 = 1, minStrokeWidth = 0, lFactor = 1, lMin = 0, triple = 3,
        sextuple = 6, sNormalizedOffset = 1, phaseNumerator = 1, defaultRgbMin = 0, defaultVelocity = 0,
        defaultLoops = 0, defaultTime = 0, defaultZoom = 1;
    ...
    class Vector3d {
        ...
        getLengthSq() {
            return this.x ** squareExp$1 + this.y ** squareExp$1;
        }
    ...
    const minRadius$5 = 0, minMemoizeSize = 0;

    function memoize(fn, options) {
        const cache = new Map(), maxSize = options?.maxSize, ttlMs = options?.ttlMs, keyFn = options?.keyFn,
            stableStringify = (obj, seen = new WeakSet()) => {
                if (obj === null) {
                    return "null";
                }
                const t = typeof obj;
            ...
            }, defaultKeyer = (args) => stableStringify(args),
            makeKey = (args) => (keyFn ? keyFn(args) : defaultKeyer(args)), ensureBounds = () => {
    ...
    function isPointInside(point, size, offset, radius, direction) {
        return areBoundsInside(calculateBounds(point, radius ?? minRadius$5), size, offset, direction);
    }
    ...
    function deepExtend(destination, ...sources) {
        for (const source of sources) {
            ...
            const sourceKeys = Object.keys(source), dangerousKeys = new Set(["__proto__", "constructor", "prototype"]),
    ...
    function circleBounce(p1, p2) {
        ...
        const angle = -Math.atan2(yDist, xDist), m1 = p1.mass, m2 = p2.mass, u1 = p1.velocity.rotate(angle),
            u2 = p2.velocity.rotate(angle), v1 = collisionVelocity(u1, u2, m1, m2),
            v2 = collisionVelocity(u2, u1, m1, m2), vFinal1 = v1.rotate(-angle), vFinal2 = v2.rotate(-angle);
    ...
    function updateAnimation(particle, data, changeDirection, destroyType, delta) {
        ...
        const velocity = (data.velocity ?? minVelocity) * delta.factor, minValue = data.min, maxValue = data.max,
    ...
    class Engine {
        ...
        async load(params) {
            ...
            const {Container} = await Promise.resolve().then(function () {
                    return Container$1;
                }),
                id = params.id ?? domSourceElement?.id ?? `tsparticles${Math.floor(getRandom() * loadRandomFactor).toString()}`, {
                    index,
                    url
                } = params, options = url ? await getDataFromUrl({fallback: params.options, url, index}) : params.options,
                currentOptions = itemFromSingleOrMultiple(options, index), {items} = this,
                oldIndex = items.findIndex(v => v.id.description === id), newItem = new Container({
    ...
    class Circle extends BaseRange {
        ...
        intersects(range) {
            const pos1 = this.position, pos2 = range.position, r = this.radius, dx = Math.abs(pos2.x - pos1.x),
            ...
            if (range instanceof Circle || range.type === RangeType.circle) {
                ...
                const rectRange = range, {width, height} = rectRange.size,
                    edges = Math.pow(dx - width, squareExp$1) + Math.pow(dy - height, squareExp$1);
                return edges <= r ** squareExp$1 || (dx <= r + width && dy <= r + height) || dx <= width || dy <= height;
            }
            return false;
        }
    ...
    class Rectangle extends BaseRange {
        ...
        intersects(range) {
            ...
            const w = this.size.width, h = this.size.height, pos1 = this.position, pos2 = range.position,
                size2 = range.size, w2 = size2.width, h2 = size2.height;
    ...
    class ParticlesOptions {
        ...
        _importPalette = (palette) => {
            ...
            const paletteColors = paletteData.colors, defaultPaintStrokeWidth = 0, defaultPaintVariantsLength = 1,
                firstPaintVariantIndex = 0, defaultPalettePaintVariant = {},
                colorVariants = isArray(paletteColors) ? paletteColors : [paletteColors],
                palettePaintVariants = colorVariants.flatMap(variant => {
    ...
    function drawParticle(data) {
        const {container, context, particle, delta, colorStyles, radius, opacity, transform} = data, {
                effectDrawers,
                shapeDrawers
            } = container, pos = particle.getPosition(), transformData = particle.getTransformData(transform),
            drawScale = defaultZoom, drawPosition = {
                x: pos.x,
                y: pos.y,
            };
    ...
    function getCachedStyle(key, generator) {
        ...
        if (!cached) {
            ...
            if (styleCache.size >= maxCacheSize) {
                const keysToDelete = [...styleCache.keys()].slice(firstIndex$1, maxCacheSize * half$1);
    ...
    function rgbToHsl(color) {
        const r1 = color.r / rgbMax, g1 = color.g / rgbMax, b1 = color.b / rgbMax, max = Math.max(r1, g1, b1),
            min = Math.min(r1, g1, b1), res = {
                h: hMin,
                l: (max + min) * half$1,
                s: sMin,
            };
        if (max !== min) {
            res.s = res.l < half$1 ? (max - min) / (max + min) : (max - min) / (double - max - min);
            if (r1 === max) {
                res.h = (g1 - b1) / (max - min);
            } else if (g1 === max) {
    ...
    function hslToRgb(hsl) {
        const h = ((hsl.h % hMax) + hMax) % hMax, s = Math.max(sMin, Math.min(sMax, hsl.s)),
            l = Math.max(lMin, Math.min(lMax, hsl.l)), hNormalized = h / hMax, sNormalized = s / sMax,
            lNormalized = l / lMax;
        if (s === sMin) {
    ...
    function getRandomRgbColor(min) {
        const fixedMin = min ?? defaultRgbMin, fixedMax = rgbMax + identity$3,
            getRgbInRangeValue = () => Math.floor(getRandomInRange(fixedMin, fixedMax));
        return {
    ...
    function getStyleFromRgb(color, hdr, opacity) {
        const op = opacity ?? defaultOpacity$3,
    ...
    function getHdrStyleFromRgb(color, opacity) {
        return `color(display-p3 ${(color.r / rgbMax).toString()} ${(color.g / rgbMax).toString()} ${(color.b / rgbMax).toString()} / ${(opacity ?? defaultOpacity$3).toString()})`;
    }
    ...
    function getSdrStyleFromHsl(color, opacity) {
        return `hsla(${color.h.toString()}, ${color.s.toString()}%, ${color.l.toString()}%, ${(opacity ?? defaultOpacity$3).toString()})`;
    }
    ...
    function updateColorValue(data, decrease, delta) {
        ...
        const offset = data.offset ? randomInRangeValue(data.offset) : minOffset,
            ...
            decay = data.decay ?? identity, max = data.max, min = data.min;
    ...
    function drawCircle(data) {
        ...
        particle.circleRange ??= {min: minAngle$1, max: doublePI};
    ...
    const shorthandHexRegex = /^#?([a-f\d])([a-f\d])([a-f\d])([a-f\d])?$/i,
        hexRegex = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})?$/i, hexRadix = 16, defaultAlpha = 1,
        alphaFactor = 0xff;
    ...
    class MovePlugin {
        ...
        async getPlugin(container) {
            const {MovePluginInstance} = await Promise.resolve().then(function () {
                return MovePluginInstance$1;
            });
    ...
    const minVelocity$5 = 0, boundsMin = 0;
    ...
    function bounceHorizontal(data) {
        ...
        if ((data.direction === exports.OutModeDirection.right &&
                ...
                velocity > minVelocity$5) ||
            (data.direction === exports.OutModeDirection.left && data.bounds.left <= boundsMin && velocity < minVelocity$5)) {
    ...
    function bounceVertical(data) {
        ...
        if ((data.direction === exports.OutModeDirection.bottom &&
                ...
                velocity > minVelocity$5) ||
            (data.direction === exports.OutModeDirection.top && data.bounds.top <= boundsMin && velocity < minVelocity$5)) {
    ...
    class BounceOutMode {
        ...
        update(particle, direction, delta, outMode) {
            ...
            const pos = particle.getPosition(), offset = particle.offset, size = particle.getRadius(),
                bounds = calculateBounds(pos, size), canvasSize = container.canvas.size;
            bounceHorizontal({particle, outMode, direction, bounds, canvasSize, offset, size});
            bounceVertical({particle, outMode, direction, bounds, canvasSize, offset, size});
        }
    }

    const minVelocity$4 = 0;
        ...
        update(particle, direction, _delta, outMode) {
            ...
            switch (particle.outType) {
                ...
                case exports.ParticleOutType.inside: {
                    ...
                    if ((vx < minVelocity$4 && dx > particle.moveCenter.radius) ||
                        (vy < minVelocity$4 && dy > particle.moveCenter.radius) ||
                        (vx >= minVelocity$4 && dx < -particle.moveCenter.radius) ||
                        (vy >= minVelocity$4 && dy < -particle.moveCenter.radius)) {
                        return;
                    }
                    break;
    ...
    class NoneOutMode {
        ...
        update(particle, direction, _delta, outMode) {
            ...
            const gravityOptions = particle.options.move.gravity, container = this.container,
                canvasSize = container.canvas.size, pRadius = particle.getRadius();
            if (!gravityOptions.enable) {
                if ((particle.velocity.y > minVelocity$3 && particle.position.y <= canvasSize.height + pRadius) ||
                    (particle.velocity.y < minVelocity$3 && particle.position.y >= -pRadius) ||
                    (particle.velocity.x > minVelocity$3 && particle.position.x <= canvasSize.width + pRadius) ||
                    (particle.velocity.x < minVelocity$3 && particle.position.x >= -pRadius)) {
                    return;
                }
    ...
    const minVelocity$2 = 0, minDistance$6 = 0, updateVector$1 = Vector.origin;
        ...
        update(particle, direction, _delta, outMode) {
            ...
            switch (particle.outType) {
                case exports.ParticleOutType.inside: {
                    ...
                    if ((vx <= minVelocity$2 && dx >= minDistance$6) ||
                        (vy <= minVelocity$2 && dy >= minDistance$6) ||
                        (vx >= minVelocity$2 && dx <= minDistance$6) ||
                        (vy >= minVelocity$2 && dy <= minDistance$6)) {
                        return;
                    }
    ...
    class PaintUpdater {
        ...
        init(particle) {
            const container = this._container, options = particle.options,
                ...
                color = paint?.color, paintColor = color ?? undefined, fill = paint?.fill, stroke = paint?.stroke;
            if (fill) {
    ...
    class SizeUpdater {
        ...
        init(particle) {
            const container = this._container, sizeOptions = particle.options.size,
    ...
    easingsFunctions.set(exports.EasingType.easeInQuad, value => value ** 2);
    easingsFunctions.set(exports.EasingType.easeOutQuad, value => 1 - (1 - value) ** 2);
    ...
    function drawEmoji(data, image) {
        const {context, opacity} = data, previousAlpha = context.globalAlpha, diameter = image.width,
            radius = diameter * half$1;
        context.globalAlpha = opacity;
    ...
    const defaultFont = '"Apple Color Emoji", "Segoe UI Emoji", "Noto Color Emoji", sans-serif', noPadding = 0,
        firstItem = 0;
    ...
    class EmojiDrawer {
        ...
        async init(container) {
            ...
            const promises = [loadFont(defaultFont)],
                shapeOptions = validTypes.map(t => shapeData.options[t])[firstItem];
        ...
        particleInit(container, particle) {
            ...
            const padding = emojiOptions.padding * double, maxSize = getRangeMax(particle.size.value),
                fullSize = maxSize + padding, canvasSize = fullSize * double,
    ...
    class InteractivityPlugin {
        ...
        async getPlugin(container) {
            const {InteractivityPluginInstance} = await Promise.resolve().then(function () {
                return InteractivityPluginInstance$1;
            });
    ...
    const clickEvent = "click", mouseDownEvent = "pointerdown", mouseUpEvent = "pointerup",
        mouseLeaveEvent = "pointerleave", mouseMoveEvent = "pointermove", touchStartEvent = "touchstart",
    ...
    function processAttract(pluginManager, container, position, attractRadius, area, queryCb, onAttractParticle) {
        ...
        for (const particle of query) {
            const {dx, dy, distance} = getDistances(particle.position, position),
                ...
                attractFactor = clamp(pluginManager.getEasing(attractOptions.easing)(identity$3 - distance / attractRadius) * velocity, minFactor, attractOptions.maxSpeed);
    ...
    const attractMode = "attract", minVelocityLengthSq = 0, minRestoreSpeed$1 = 0.001, maxRestoreSpeed$1 = 1,
        restoreEpsilon$1 = 0.5;
    let Attractor$1 = class Attractor extends ExternalInteractorBase {
        ...
        interact(interactivityData) {
            ...
            const container = this.container, options = container.actualOptions,
                mouseMoveStatus = interactivityData.status === mouseMoveEvent, events = options.interactivity?.events;
            if (!events) {
                return;
            }
        ...
        isEnabled(interactivityData, particle) {
            const container = this.container, options = container.actualOptions, mouse = interactivityData.mouse,
        ...
        _restoreParticles() {
            ...
            const now = Date.now(), restoreDelay = restore.delay * millisecondsToSeconds,
                restoreSpeed = Math.max(minRestoreSpeed$1, Math.min(maxRestoreSpeed$1, restore.speed));
            for (const [particle, restoreData] of this._restoreData) {
                ...
                let dx = target.x - particle.position.x, dy = target.y - particle.position.y,
    ...
    const squareExp = 2, halfPI = Math.PI * half$1, toleranceFactor$1 = 10, minRadius$3 = 0, minVelocity$1 = 0;
    ...
    function singleSelectorBounce(container, selector, div, bounceCb) {
        ...
        query.forEach(item => {
            const elem = item, pxRatio = container.retina.pixelRatio, pos = {
                    x: (elem.offsetLeft + elem.offsetWidth * half$1) * pxRatio,
                    y: (elem.offsetTop + elem.offsetHeight * half$1) * pxRatio,
                }, radius = elem.offsetWidth * half$1 * pxRatio, tolerance = toleranceFactor$1 * pxRatio,
                area = div.type === DivType.circle
    ...
    function mouseBounce(container, interactivityData, enabledCb) {
        const pxRatio = container.retina.pixelRatio, tolerance = toleranceFactor$1 * pxRatio,
            mousePos = interactivityData.mouse.position, radius = container.retina.bounceModeDistance;
        if (!radius || radius < minRadius$3 || !mousePos) {
            return;
        }
    ...
    function rectSideBounce(data) {
        ...
        if ((pSide.max >= rectSide.min && pSide.max <= (rectSide.max + rectSide.min) * half$1 && velocity > minVelocity$1) ||
            (pSide.min <= rectSide.max && pSide.min > (rectSide.max + rectSide.min) * half$1 && velocity < minVelocity$1)) {
    ...
    function rectBounce(particle, divBounds) {
        const pPos = particle.getPosition(), size = particle.getRadius(), bounds = calculateBounds(pPos, size),
            bounceOptions = particle.options.bounce, resH = rectSideBounce({
                pSide: {
                    min: bounds.left,
                    max: bounds.right,
                },
    ...
    class Bouncer extends ExternalInteractorBase {
        ...
        interact(interactivityData) {
            const container = this.container, options = container.actualOptions, events = options.interactivity?.events,
    ...
    const bubbleMode = "bubble", minDistance$5 = 0, defaultClickTime = 0, defaultOpacity$1 = 1, ratioOffset = 1,
        defaultBubbleValue = 0, minRatio = 0, defaultRatio = 1;
    ...
    class Bubbler extends ExternalInteractorBase {
        ...
        interact(interactivityData, delta) {
            ...
            const onHover = events.onHover, onClick = events.onClick, hoverEnabled = onHover.enable,
                hoverMode = onHover.mode, clickEnabled = onClick.enable, clickMode = onClick.mode, divs = events.onDiv;
        ...
        _clickBubble = interactivityData => {
            ...
            for (const particle of query) {
                ...
                const pos = particle.getPosition(), distMouse = getDistance(pos, mouseClickPos),
                    timeSpent = (performance.now() - (interactivityData.mouse.clickTime ?? defaultClickTime)) / millisecondsToSeconds;
        ...
        _hoverBubble = interactivityData => {
            const container = this.container, mousePos = interactivityData.mouse.position,
        ...
        _hoverBubbleOpacity = (particle, ratio, divBubble) => {
            ...
            const optOpacity = particle.options.opacity.value, pOpacity = particle.opacity?.value ?? defaultOpacity$1,
        ...
        _hoverBubbleSize = (particle, ratio, divBubble) => {
            ...
            const optSize = getRangeMax(particle.options.size.value) * container.retina.pixelRatio,
                pSize = particle.size.value, size = calculateBubbleValue(pSize, modeSize, optSize, ratio);
            if (size !== undefined) {
                particle.bubble.radius = size;
            }
        };
        _process = (particle, distMouse, timeSpent, data) => {
            const container = this.container, bubbleParam = data.bubbleObj.optValue, options = container.actualOptions,
                bubbleOptions = options.interactivity?.modes.bubble;
            if (!bubbleOptions || bubbleParam === undefined) {
                return;
            }
            const bubbleDuration = bubbleOptions.duration, bubbleDistance = container.retina.bubbleModeDistance,
                particlesParam = data.particlesObj.optValue, pObjBubble = data.bubbleObj.value,
                pObj = data.particlesObj.value ?? defaultBubbleValue, type = data.type;
        ...
        _singleSelectorHover = (interactivityData, delta, selector, div) => {
            const container = this.container, selectors = safeDocument().querySelectorAll(selector),
            ...
            selectors.forEach(item => {
                const elem = item, pxRatio = container.retina.pixelRatio, pos = {
                        x: (elem.offsetLeft + elem.offsetWidth * half$1) * pxRatio,
                        y: (elem.offsetTop + elem.offsetHeight * half$1) * pxRatio,
                    }, repulseRadius = elem.offsetWidth * half$1 * pxRatio, area = div.type === DivType.circle
    ...
    function gradient(container, context, p1, p2, opacity) {
        const gradStop = Math.floor(p2.getRadius() / p1.getRadius()), color1 = p1.getFillColor(),
            color2 = p2.getFillColor();
        if (!color1 || !color2) {
            return;
        }
        const sourcePos = p1.getPosition(), destPos = p2.getPosition(),
    ...
    class Connector extends ExternalInteractorBase {
            ...
            if (options.interactivity?.events.onHover.enable && interactivityData.status === "pointermove") {
                ...
                query.forEach((p1, i) => {
                    ...
                    for (const p2 of query.slice(i + indexOffset)) {
                        const pos2 = p2.getPosition(), distMax = Math.abs(connectModeDistance),
                            xDiff = Math.abs(pos1.x - pos2.x), yDiff = Math.abs(pos1.y - pos2.y);
        ...
        isEnabled(interactivityData, particle) {
            const container = this.container, mouse = interactivityData.mouse,
    ...
    const half = 0.5, toleranceFactor = 10, minRadius$2 = 0;
    ...
    function mouseDestroy(container, interactivityData) {
        const pxRatio = container.retina.pixelRatio, tolerance = toleranceFactor * pxRatio,
            mousePos = interactivityData.mouse.position, radius = container.retina.destroyModeDistance;
    ...
    class Grabber extends ExternalInteractorBase {
        ...
        interact(interactivityData) {
            ...
            for (const particle of query) {
                ...
                const grabLineOptions = interactivity.modes.grab.links, lineOpacity = grabLineOptions.opacity,
    ...
    class Parallaxer extends ExternalInteractorBase {
        ...
        _parallaxInteract(interactivityData, particle) {
            ...
            const canvasSize = container.canvas.size, canvasCenter = {
                    x: canvasSize.width * half$1,
                    y: canvasSize.height * half$1,
                }, parallaxSmooth = parallaxOptions.smooth, factor = particle.getRadius() / parallaxForce,
                centerDistance = {
    ...
    const repulseMode = "repulse", minDistance$2 = 0, repulseRadiusFactor = 6, repulseRadiusPower = 3, squarePower = 2,
        minRadius$1 = 0, minSpeed = 0, easingOffset = 1, minRestoreSpeed = 0.001, maxRestoreSpeed = 1,
        restoreEpsilon = 0.5;
    ...
    class Repulser extends ExternalInteractorBase {
        ...
        interact(interactivityData) {
            ...
            const hover = events.onHover, hoverEnabled = hover.enable, hoverMode = hover.mode, click = events.onClick,
                clickEnabled = click.enable, clickMode = click.mode, divs = events.onDiv;
        ...
        isEnabled(interactivityData, particle) {
            ...
            const divs = events.onDiv, hover = events.onHover, click = events.onClick,
            ...
            if (repulse.clicking) {
                ...
                for (const particle of query) {
                    const {dx, dy, distance} = getDistances(mouseClickPos, particle.position),
                        d = distance ** squarePower, velocity = repulseOptions.speed,
        ...
        _processRepulse = (interactivityData, position, repulseRadius, area, divRepulse) => {
            ...
            const {easing, speed, factor, maxSpeed} = repulseOptions,
                easingFunc = this._pluginManager.getEasing(easing), velocity = (divRepulse?.speed ?? speed) * factor;
            for (const particle of query) {
                const {dx, dy, distance} = getDistances(particle.position, position),
        ...
        _restoreParticles() {
            ...
            for (const [particle, restoreData] of this._restoreData) {
                ...
                const dx = target.x - particle.position.x, dy = target.y - particle.position.y,
                    dz = target.z - particle.position.z;
                particle.position.x += dx * restoreSpeed;
                particle.position.y += dy * restoreSpeed;
                particle.position.z += dz * restoreSpeed;
        ...
        _singleSelectorRepulse = (interactivityData, selector, div) => {
            ...
            query.forEach(item => {
                const elem = item, pxRatio = container.retina.pixelRatio, pos = {
                        ...
                        ? new Circle(pos.x, pos.y, repulseRadius)
                        : new Rectangle(elem.offsetLeft * pxRatio, elem.offsetTop * pxRatio, elem.offsetWidth * pxRatio, elem.offsetHeight * pxRatio),
                    divs = repulse.divs, divRepulse = divMode(divs, elem);
    ...
    class Slower extends ExternalInteractorBase {
        ...
        reset(interactivityData, particle) {
            ...
            const container = this.container, options = container.actualOptions,
                mousePos = interactivityData.mouse.position, radius = container.retina.slowModeRadius,
                slowOptions = options.interactivity?.modes.slow;
            if (!slowOptions || !radius || radius < minRadius || !mousePos) {
                return;
            }
            const particlePos = particle.getPosition(), dist = getDistance(mousePos, particlePos),
                proximityFactor = dist / radius, slowFactor = slowOptions.factor, {slow} = particle;
            if (dist > radius) {
                return;
            }
            slow.inRange = true;
    ...
    function replaceImageColor(image, imageData, color, particle, hdr = false) {
        ...
        return new Promise(resolve => {
            const svg = new Blob([svgColoredData], {type: "image/svg+xml"}), url = URL.createObjectURL(svg),
                img = new Image();
            img.addEventListener("load", () => {
    ...
    async function parseImageBlock(byteStream, gif, avgAlpha, getFrameIndex, getTransparencyIndex, canvasSettings, progressCallback) {
        ...
        const packedByte = byteStream.nextByte(), localColorTableFlag = (packedByte & 0x80) === 0x80,
        ...
        const minCodeSize = byteStream.nextByte(), imageData = byteStream.readSubBlocksBin(),
    ...
    function drawGif(data, canvasSettings) {
        ...
        const pos = {x: -image.gifData.width * half$1, y: -image.gifData.height * half$1},
    ...
    class ImagePreloaderPlugin {
        ...
        async getPlugin(container) {
            const {ImagePreloaderInstance} = await Promise.resolve().then(function () {
                return ImagePreloaderInstance$1;
            });
    ...
    class LifeUpdater {
        ...
        init(particle) {
            ...
            const delayFactor = lifeOptions.delay.sync ? identity$2 : getRandom(),
                durationFactor = lifeOptions.duration.sync ? identity$2 : getRandom();
            particle.life = {
    ...
    class Attractor extends ParticlesInteractorBase {
        ...
        interact(p1) {
            ...
            const distance = p1.attractDistance, pos1 = p1.getPosition(),
                query = container.particles.grid.queryCircle(pos1, distance);
            for (const p2 of query) {
                if (p1 === p2 || !p2.options.attract?.enable || p2.destroyed || p2.spawning) {
                    continue;
                }
                const pos2 = p2.getPosition(), {dx, dy} = getDistances(pos1, pos2), rotate = p1.options.attract.rotate,
                    ax = dx / (rotate.x * attractFactor), ay = dy / (rotate.y * attractFactor),
                    p1Factor = p2.size.value / p1.size.value, p2Factor = identity$1 / p1Factor;
    ...
    const energyCorrectionMinRatio = 1e-6, energyDriftThreshold = 1e-4, correctionFactorNeutral = 1,
        fixBounceSpeed = (p) => {
    ...
    function bounce(p1, p2) {
        const m1 = p1.getMass(), m2 = p2.getMass(), speed1Before = p1.velocity.length,
            speed2Before = p2.velocity.length,
            keBefore = m1 * speed1Before * speed1Before + m2 * speed2Before * speed2Before;
        circleBounce(circleBounceDataFromParticle(p1), circleBounceDataFromParticle(p2));
        const speed1After = p1.velocity.length, speed2After = p2.velocity.length,
    ...
    class Collider extends ParticlesInteractorBase {
        ...
        interact(p1, _interactivityData, delta) {
            ...
            const container = this.container, pos1 = p1.getPosition(), radius1 = p1.getRadius(),
                query = container.particles.grid.queryCircle(pos1, radius1 * double);
            for (const p2 of query) {
                if (p1 === p2 ||
                    p1.id >= p2.id ||
    ...
    class OverlapPlugin {
        ...
        async getPlugin(container) {
            const {OverlapPluginInstance} = await Promise.resolve().then(function () {
                return OverlapPluginInstance$1;
            });
    ...
    class Linker extends ParticlesInteractorBase {
        ...
        interact(p1) {
            ...
            const linkOpt1 = p1.options.links, optOpacity = linkOpt1.opacity,
                optDistance = p1.retina.linksDistance ?? minDistance$1, warp = linkOpt1.warp,
                range = warp ? new CircleWarp(pos1.x, pos1.y, optDistance, canvasSize) : new Circle(pos1.x, pos1.y, optDistance),
                query = container.particles.grid.query(range);
            for (const p2 of query) {
    ...
    class LinksPlugin {
        ...
        async getPlugin(container) {
            const {LinkInstance} = await Promise.resolve().then(function () {
                return LinkInstance$1;
            });
    ...
    function getUnitPolygon(sides) {
        ...
        const step = doublePI / sides, isOdd = !!(sides % double),
            baseAngle = (-Math.PI + (isOdd ? noOffset : step)) * half$1, verts = [];
    ...
    function drawPolygon(data, side) {
        const {context, radius} = data, sides = side.count.numerator / side.count.denominator,
    ...
    class RenderManager {
        ...
        drawParticle(particle, delta) {
            ...
            const container = this._container, zIndexOptions = particle.options.zIndex,
                zIndexFactor = zIndexFactorOffset - particle.zIndexFactor, {
                    fillOpacity,
                    opacity,
                    strokeOpacity
                } = particle.getOpacity(), transform = this._reusableTransform, colorStyles = this._reusableColorStyles,
    ...
    class CanvasManager {
        ...
        getZoomCenter() {
            ...
            return {
                x: (width * half$1) / pxRatio,
                y: (height * half$1) / pxRatio,
            };
        }
        ...
        initBackground() {
            const {_container} = this, options = _container.actualOptions, background = options.background,
    ...
    class Particle {
        ...
        getMass() {
            return this.getRadius() ** squareExp$1 * Math.PI * half$1;
        }

        getOpacity() {
            const zIndexOptions = this.options.zIndex, zIndexFactor = zIndexFactorOffset - this.zIndexFactor,
                zOpacityFactor = zIndexFactor ** zIndexOptions.opacityRate,
                opacity = this.bubble.opacity ?? getRangeValue(this.opacity?.value ?? defaultOpacity$3),
                fillOpacity = this.fillOpacity ?? defaultOpacity$3,
                strokeOpacity = this.strokeOpacity ?? defaultOpacity$3;
        ...
        init(id, position, overrideOptions, group) {
            ...
            const pxRatio = container.retina.pixelRatio, mainOptions = container.actualOptions,
                particlesOptions = loadParticlesOptions(this._pluginManager, container, mainOptions.particles),
                reduceDuplicates = particlesOptions.reduceDuplicates, effectType = particlesOptions.effect.type,
        ...
        isShowingBack() {
            ...
            if (this.roll.horizontal) {
                const normalizedAngle = (angle + Math.PI * half$1) % (Math.PI * double),
        ...
        _calcPosition = (position, zIndex) => {
            ...
            const container = this._container, plugins = container.particlePositionPlugins,
                outModes = this.options.move.outModes, radius = this.getRadius(), canvasSize = container.canvas.size,
        ...
        _calculateVelocity = () => {
            ...
            const rad = degToRad(getRangeValue(moveOptions.angle.value)),
                radOffset = degToRad(getRangeValue(moveOptions.angle.offset)), range = {
                    left: radOffset - rad * half$1,
                    right: radOffset + rad * half$1,
                };
        ...
        _initPosition = position => {
            const container = this._container, zIndexValue = Math.floor(getRangeValue(this.options.zIndex.value)),
    ...
    class Retina {
        ...
        initParticle(particle) {
            const options = particle.options, ratio = this.pixelRatio, moveOptions = options.move,
                moveDistance = moveOptions.distance, props = particle.retina;
    ...
    const minVelocity = 0, identity = 1, moveSpeedFactor = 60, minSpinRadius = 0, spinFactor = 0.01,
        defaultPathDelay = 0, noDecay = 1;

    function applyDistance(particle) {
        const initialPosition = particle.initialPosition, {dx, dy} = getDistances(initialPosition, particle.position),
            dxFixed = Math.abs(dx), dyFixed = Math.abs(dy), {maxDistance} = particle.retina,
            hDistance = maxDistance.horizontal, vDistance = maxDistance.vertical;
        ...
        if ((hasHDistance || hasVDistance) && !particle.misplaced) {
            ...
            if (hDistance) {
                particle.velocity.x = particle.velocity.y * half$1 - particle.velocity.x;
            }
            if (vDistance) {
                particle.velocity.y = particle.velocity.x * half$1 - particle.velocity.y;
            }
    ...
    function spin(container, particle, moveSpeed, reduceFactor) {
        ...
        const maxCanvasSize = Math.max(container.canvas.size.width, container.canvas.size.height),
            halfMaxSize = maxCanvasSize * half$1;
    ...
    function applyPath(particle, delta) {
        const particlesOptions = particle.options, pathOptions = particlesOptions.move.path,
    ...
    function initSpin(container, particle) {
        ...
        const spinPos = spinOptions.position ?? {x: 50, y: 50}, spinFactor = 0.01, spinCenter = {
            ...
            }, pos = particle.getPosition(), distance = getDistance(pos, spinCenter),
    ...
    class MovePluginInstance {
        ...
        particleCreated(particle) {
            const options = particle.options, moveOptions = options.move, gravityOptions = moveOptions.gravity,
        ...
        particleUpdate(particle, delta) {
            ...
            const container = this._container, pxRatio = container.retina.pixelRatio,
                slowFactor = getProximitySpeedFactor(particle), reduceFactor = container.retina.reduceFactor,
                baseSpeed = particle.retina.moveSpeed, moveDrift = particle.retina.moveDrift,
                ...
                moveSpeed = baseSpeed * sizeFactor * slowFactor * deltaFactor * half$1,
    ...
    class InteractivityEventListeners {
        ...
        _doMouseTouchClick = e => {
            const container = this._container, interactionManager = this._interactionManager,
        ...
        _manageInteractivityListeners = add => {
            const handlers = this._handlers, container = this._container, interactionManager = this._interactionManager,
                options = container.actualOptions, interactivityEl = interactionManager.interactivityData.element;
            if (!interactivityEl) {
                return;
            }
        ...
        _manageListeners = add => {
            const handlers = this._handlers, container = this._container, interactionManager = this._interactionManager,
                options = container.actualOptions, detectType = options.interactivity?.detectsOn,
        ...
        _mouseTouchClick = e => {
            const container = this._container, interactionManager = this._interactionManager,
                options = container.actualOptions, {mouse} = interactionManager.interactivityData;
            mouse.inside = true;
            let handled = false;
        ...
        _mouseTouchMove = e => {
            const container = this._container, interactionManager = this._interactionManager,
                options = container.actualOptions, interactivity = interactionManager.interactivityData,
                canvasEl = container.canvas.domElement;
            ...
            if (e.type.startsWith("pointer")) {
                ...
                if (canvasEl) {
                    const touchEvent = e, lastTouch = touchEvent.touches[touchEvent.touches.length - lengthOffset],
                        canvasRect = canvasEl.getBoundingClientRect();
                    if (!lastTouch) {
                        return;
                    }
            ...
            const clickOrTouchHandler = (e, pos, radius) => {
                ...
                if (touched && !touchMoved) {
                    ...
                    const element = container.canvas.domElement,
                        canvasRect = element ? element.getBoundingClientRect() : undefined, pos = {
    ...
    class LinkInstance {
        ...
        drawParticle(context, particle) {
            ...
            const linkOpts = options.links, width = particle.retina.linksWidth ?? minWidth,
                pos1 = particle.getPosition(), twinkle = particle.options["twinkle"]?.links,
            ...
            for (const link of links) {
                ...
                if (link.isWarped) {
                    ...
                    if (Math.abs(dx) > canvasSize.width * half$1) {
                        sx = dx > minDistance ? -canvasSize.width : canvasSize.width;
                    }
                    if (Math.abs(dy) > canvasSize.height * half$1) {
        ...
        _drawTriangles(options, p1, link, p1Destinations, pos1, pos2, context) {
            ...
            for (const vertex of p2Links) {
                ...
                const opacityTriangle = triangleOptions.opacity ?? (link.opacity + vertex.opacity) * half$1,
    ...
    exports.minVelocity = minVelocity$6;
    exports.minZ = minZ;
...
Object.assign(globalThis.window || globalThis, {
    loadMinIndex: (globalThis.__tsParticlesInternals.bundles.slim || {}).loadMinIndex,
    loadOptions: (globalThis.__tsParticlesInternals.bundles.slim || {}).loadOptions,
    loadParticlesOptions: (globalThis.__tsParticlesInternals.bundles.slim || {}).loadParticlesOptions,
    loadRandomFactor: (globalThis.__tsParticlesInternals.bundles.slim || {}).loadRandomFactor,
    loadSlim: (globalThis.__tsParticlesInternals.bundles.slim || {}).loadSlim,
    tsParticles: (globalThis.__tsParticlesInternals.bundles.slim || {}).tsParticles
});
...
if (!globalThis.__tsParticlesInternals.engine || !globalThis.__tsParticlesInternals.engine.tsParticles) {
    globalThis.__tsParticlesInternals.engine = globalThis.__tsParticlesInternals.bundles.slim || {};
}
